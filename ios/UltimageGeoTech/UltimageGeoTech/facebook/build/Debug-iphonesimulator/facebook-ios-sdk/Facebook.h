...
@property(nonatomic, retain) id<FBSessionDelegate> sessionDelegate;//Chriag:Got solution from (http://stackoverflow.com/questions/5948011/facebook-fbconnect-fbdialoglogin-method-in-facebook-m-hits-exc-bad-access-on-fbs)
